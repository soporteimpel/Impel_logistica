...
const Foto3_det = ({foto_prueba3,idprueba1}) => {
    ...
    const enviarImagen = async (uri) => {
      try {
        ...
        enviarImagenBase64_pruebas(idprueba1,base64Image,"foto3_base64")
  ...
  return (
    ...
    <Pressable style={styles.boton} >
        {fotocargando ? (
          ...
          <>
            {(photo || (foto_prueba3 && foto_prueba3 !== '')) ? (
              <Image source={{ uri: photo ? photo.uri : foto_prueba3 }} style={styles.image} />
            ) : (
