...
const Foto4_det = ({foto_prueba4,idprueba1}) => {
    ...
    const enviarImagen = async (uri) => {
      try {
        ...
        enviarImagenBase64_pruebas(idprueba1,base64Image,"foto4_base64")
  ...
  return (
    ...
    <Pressable style={styles.boton} >
        {fotocargando ? (
          ...
          <>
            {(photo || (foto_prueba4 && foto_prueba4 !== '')) ? (
              <Image source={{ uri: photo ? photo.uri : foto_prueba4 }} style={styles.image} />
            ) : (
