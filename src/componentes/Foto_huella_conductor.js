...
import { datosConductor_firma_huella,enviarhuellaBase64conductor } from '../helpers/index_peticiones';
const Foto_huella_conductor = ({idConductor}) => {
    ...
    const enviarImagen = async (uri) => {
      try {
        ...
        enviarhuellaBase64conductor(base64Image,idConductor)
        if (!base64Image) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.texto}> Huella</Text>
...
export default Foto_huella_conductor