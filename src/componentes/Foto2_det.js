...
const Foto2_det = ({foto_prueba2,idprueba1}) => {
    ...
    const enviarImagen = async (uri) => {
      try {
        ...
        enviarImagenBase64_pruebas(idprueba1,base64Image,"foto2_base64")
  ...
  return (
    ...
    <Pressable style={styles.boton} >
        {fotocargando ? (
          ...
          <>
            {(photo || (foto_prueba2 && foto_prueba2 !== '')) ? (
              <Image source={{ uri: photo ? photo.uri : foto_prueba2 }} style={styles.image} />
            ) : (
    ...
    <Text style={styles.texto}>Foto 2</Text>
