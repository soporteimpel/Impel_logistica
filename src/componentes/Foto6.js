...
const FotoPQR_creacion_6 = ({ urlImagen,setfoto_6_formulario,setResetFoto6 }) => {
  ...
  const enviarImagen = async (uri) => {
    try {
      ...
      setfoto_6_formulario(base64Image)
      if (!base64Image) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.texto}>Recibo 2</Text>
...
export default FotoPQR_creacion_6
